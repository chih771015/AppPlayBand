...
class StoreDetailViewController: UIViewController {
    ...
    private func setupTableView() {
        ...
        tableView.lv_registerCellWithNib(identifier: String(describing: StoreDescriptionTableViewCell.self), bundle: nil)
        tableView.lv_registerCellWithNib(identifier: String(describing: StoreInformationTableViewCell.self), bundle: nil)
    }
}
