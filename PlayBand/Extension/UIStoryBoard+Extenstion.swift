...
extension UIStoryboard {
    ...
    static var signIn: UIStoryboard { return pbStoryboard(name: StoryboardCategory.signIn)}
    
    static var chat: UIStoryboard { return pbStoryboard(name: StoryboardCategory.chat)}
